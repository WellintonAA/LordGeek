...
<html lang="en">
    <?php 
        $title = 'Lord Geek - Séries- American Horro Story';
...
<body>
    ...
    <div class="well"><b>American Horro Story</b> </div>
    ...
    <section class=" col-md-6 col-sm-6 col-lg-6 twd thumbnail">
           ...
           <div class="panel panel-primary">
                ...
                <figure>
  <img  src="./img/series/supenatural.jpg" class=" text-center img-responsive" alt="twd">
