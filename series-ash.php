...
<body>
    ...
    <section class=" col-md-6 col-sm-6 col-lg-6 twd thumbnail">
           ...
           <div class="panel panel-primary">
                ...
                <figure>
  <img  src="./img/series/ashevil.jpg" class=" text-center img-responsive" alt="twd">
  <figcaption><span class="hid">Nova temporada</span></figcaption>
</figure>
               
               
               
               <p>Na Filadelfia, cinco pessoas que nunca se viram, ficam presas num elevador de um arranha céu comercial. Enquanto rumavam para seus respectivos andares, algo acontece e ele para no meio do caminho. E o que para muitos já seria motivo de tensão, piora ainda mais porque estranhos e violentos acontecimentos começam a surgir dentro do minusculo espaço. Alguém ali dentro não é quem aparenta ser. Do lado de fora, ninguém consegue arranjar um jeito de ajudá-los.</p> 
