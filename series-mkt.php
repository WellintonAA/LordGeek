...
<html lang="en">
    <?php 
        $title = 'Lord Geek - Séries- Um maluco no pedaço';
...
<body>
    ...
    <div class="well"><b>Um maluco no pedaço</b> </div>
    ...
    <section class=" col-md-6 col-sm-6 col-lg-6 twd thumbnail">
           ...
           <div class="panel panel-primary">
                ...
                <figure>
  <img  src="./img/series/mlk.jpg" class=" text-center img-responsive" alt="twd">
