...
<html lang="en">
    <?php 
        $title = 'Lord Geek - Séries- The last ship';
...
<body>
    ...
    <section class=" col-md-6 col-sm-6 col-lg-6 twd thumbnail">
           ...
           <div class="panel panel-primary">
                ...
                <figure>
  <img  src="./img/series/newthelast.jpg" class=" text-center img-responsive" alt="The last SHip">
  <figcaption><span class="hid"> Nova temporada</span></figcaption>
</figure>
               
               
               
               <p>The Last Ship é uma série de televisão estadunidense transmitido pelo canal TNT a partir do dia 22 de junho de 2014. Baseado em um romance de mesmo nome de William Brinkley. Dirigida e Produzida por Michael Bay[4]

Em 18 de julho de 2014, The Last Ship foi renovada para uma segunda temporada com 13 episódios</p> 
